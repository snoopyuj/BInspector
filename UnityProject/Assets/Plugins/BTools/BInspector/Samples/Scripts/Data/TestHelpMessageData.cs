...
namespace BTools.BInspector.Samples
{
    ...
    /// </summary>
    public class TestHelpMessageData : ScriptableObject
    {
        [Header("Try changing the values")]
        [HelpMessage("Show")]
        public int i = -1;
        ...
        private HelpMessageContent helpMsgContent = new HelpMessageContent(HelpType.None, null);
